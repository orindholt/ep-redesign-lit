          ...
          >
            <div>
              <img
                ...
                src="./images/footer/gambleaware.png"
              />
            </div>
            <div>
              <img
                class=${tw`max-w-[10.938rem] max-h-14 px-2`}
                src="./images/footer/mga.png"
              />
            </div>
            <div>
              <img
                class=${tw`max-w-[10.938rem] max-h-14 px-2`}
                src="./images/footer/agerestrict.png"
              />
            </div>
            <div>
              <img
                class=${tw`max-w-[10.938rem] max-h-14 px-2`}
                src="./images/footer/gpwa.gif"
              />
            </div>
            <div>
              <img
                class=${tw`max-w-[10.938rem] max-h-14 px-2`}
                src="./images/footer/egr.webp"
              />
            </div>
            <div>
              <img
                class=${tw`max-w-[10.938rem] max-h-14 px-2`}
                src="./images/footer/lottofy.webp"
              />
            </div>
            <div>
              <img
                class=${tw`max-w-[10.938rem] max-h-14 px-2`}
                src="./images/footer/smartsoft.webp"
              />
            </div>
          </div>
        </div>
